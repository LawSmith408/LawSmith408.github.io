...
img: assets/img/stv/thumbSTV.webp
importance: 1
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/stv/injector.webp" title="example image" style="height:250px; width:auto;" %}
    </div>
</div>
