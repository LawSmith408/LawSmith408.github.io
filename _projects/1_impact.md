    ...
    <div class="col-12">
      <figure class="figure d-block m-0">
        ...
        <figcaption class="figure-caption text-center mt-2">
          Impact performance of foam-like gyroid structure and Plate Lattice. Plate lattices maintain near-constant peak stress across increasing impact energies, unlike the gyroid that densify.
        </figcaption>
      </figure>
    </div>
  </div>
